                      ...
                      {bestMatch && (
                        <div className="my-report-card__match-preview">
                          <span
                            ...
                            style={{
                              backgroundColor: (bestMatch.isAiMatch || bestMatch.imageSimilarityScore >= 80)
                                ? '#6366f1'
                                : (MATCH_LEVEL_COLOR[bestMatch.matchLevel] || {}).bg || '#f3f4f6',
                              color: (bestMatch.isAiMatch || bestMatch.imageSimilarityScore >= 80)
                                ? '#ffffff'
                                : (MATCH_LEVEL_COLOR[bestMatch.matchLevel] || {}).color || '#6b7280',
                              fontWeight: 600,
                            }}
                          >
